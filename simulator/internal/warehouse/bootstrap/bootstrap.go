...
import (
	"context"
	internalConfig "eurosupply/simulator/internal/warehouse/config"
	"eurosupply/simulator/internal/warehouse/domain"
	"eurosupply/simulator/internal/warehouse/simulator"
...
func StartSimulator(cfg *internalConfig.Config, mq *messaging.RabbitMQClient) *simulator.Simulator {
	warehouse := domain.NewWarehouse(cfg)
	sim := simulator.New(warehouse, mq.Publisher(), cfg.Simulator)
